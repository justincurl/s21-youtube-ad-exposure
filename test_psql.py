...
def upload_data(ad_entry, cursor):
    ...
    insert_statement = """
    INSERT INTO ads(username, user_behavior, video_title, video_length_seconds, num_initial_ads, skippable, ad_length_seconds, advertiser)
    VALUES ('{}', '{}', '{}', {}, {}, {}, {}, '{}');
    """.format(ad_entry[0], ad_entry[1], ad_entry[2], ad_entry[3], ad_entry[4], ad_entry[5], ad_entry[6], ad_entry[7])
